...
<head>
    ...
    <title>HotelBahagia - Point Of Sale</title>
    <!-- Bootstrap Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>">HotelBahagia</a>
            </div>
        ...
        <div id="page-wrapper">
            ...
            <!-- /. PAGE INNER  -->
            <footer>
                <p>Website : <a href="http://sourcecodeaplikasi.info" target="_blank">Richisoft</a> | Repost by <a href="https://stokcoding.com/" title="StokCoding.com" target="_blank">StokCoding.com</a></p>
            </footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
